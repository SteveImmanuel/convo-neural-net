...
def test_dense_backprop():
    ...
    layer_1._bias = np.array([0.35, 0.35])
    layer_2._bias = np.array([0.6, 0.6])
    ...
    expected_layer_1_bias = np.array([0.34561432, 0.34502287])
    expected_layer_2_bias = np.array([0.53075072, 0.61904912])
    ...
    assert np.sum(expected_layer_2_bias - layer_2._bias) < 0.00001
